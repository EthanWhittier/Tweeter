...
import edu.byu.cs.client.view.main.PlaceholderFragment;
import edu.byu.cs.client.view.main.feed.FeedFragment;
...
public class SectionsPagerAdapterProfile extends FragmentPagerAdapter {
    ...
    public SectionsPagerAdapterProfile(Context context, FragmentManager fm, User user, AuthToken authToken) {
        super(fm);
        mContext = context;
        this.user = user;
